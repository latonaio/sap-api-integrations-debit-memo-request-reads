...
import (
	...
	sap_api_input_reader "sap-api-integrations-debit-memo-request-reads/SAP_API_Input_Reader"
	"sap-api-integrations-debit-memo-request-reads/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Debit_Memo_Request_Header_sample.json")
	...
	caller.AsyncGetDebitMemoRequest(
		inputSDC.DebitMemoRequest.DebitMemoRequest,
		inputSDC.DebitMemoRequest.DebitMemoRequestItem.DebitMemoRequestItem,
		accepter,
	)
}
